...
contract AgentTabs {
    ...
    /// @notice Enforces the owner policy before any token transfer.
    /// @dev Reverts on invalid agent, merchant mode, limits, duplicate request, empty result, or insufficient vault balance.
